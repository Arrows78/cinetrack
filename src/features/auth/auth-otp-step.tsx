  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <input
        ...
        className="mt-7 h-16 w-full rounded-2xl border border-auth-foreground/20 bg-auth-background/30 px-4 text-center text-page-title font-black tracking-[0.3em] text-auth-foreground placeholder:text-auth-foreground/20 focus:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      />
      ...
      <button
        ...
        onClick={onResend}
        className="mt-4 flex h-11 w-full items-center justify-center gap-2 rounded-full text-body-sm font-semibold text-auth-foreground/65 transition hover:bg-auth-foreground/5 hover:text-auth-foreground disabled:cursor-not-allowed disabled:opacity-45"
      >
