...
export function ProviderIcon({ provider, ...props }: ProviderIconProps) {
  if (provider === "google") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
        ...
        <path fill="#FBBC05" d="M6.39 13.88A6 6 0 0 1 6.08 12c0-.65.11-1.28.31-1.88V7.51H3.04A10 10 0 0 0 2 12c0 1.61.38 3.13 1.04 4.49l3.35-2.61Z" />
        <path fill="#EA4335" d="M12 5.99c1.47 0 2.79.5 3.83 1.5l2.87-2.88A9.64 9.64 0 0 0 12 2a10 10 0 0 0-8.96 5.51l3.35 2.61C7.18 7.75 9.39 5.99 12 5.99Z" />
      </svg>
    );
  }
  ...
  if (provider === "facebook") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
        <path fill="currentColor" d="M13.7 22v-8.2h2.75l.41-3.2H13.7V8.56c0-.93.26-1.56 1.59-1.56H17V4.14A23 23 0 0 0 14.53 4c-2.44 0-4.1 1.49-4.1 4.22v2.36H7.67v3.2h2.76V22h3.27Z" />
      </svg>
    );
  }
  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path fill="currentColor" d="M18.9 2H22l-6.77 7.74L23.2 22h-6.24l-4.89-6.39L6.48 22H3.36l7.25-8.29L2.96 2h6.4l4.42 5.84L18.9 2Zm-1.1 17.84h1.72L8.42 4.05H6.57L17.8 19.84Z" />
    </svg>
  );
}
