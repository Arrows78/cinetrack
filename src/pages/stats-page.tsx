...
type StatsTab = "overview" | "thisYear" | "history" | "records";
...
export function StatsPage() {
  ...
  const cards = [
    ...
    { label: t("stats.episodesWatched"), value: stats.data.episodesWatched, icon: Tv },
    {
      ...
      value: formatWatchDurationBreakdown(stats.data.minutesWatched),
      icon: Clock,
    },
    {
  ...
  return (
    <div className="space-y-8">
      ...
      <FilterBar
        value={tab}
        onChange={setTab}
        groupLabel={t("stats.title")}
        options={[
          { value: "overview", label: t("stats.tabs.overview") },
          { value: "thisYear", label: t("stats.tabs.thisYear") },
          { value: "history", label: t("stats.tabs.history") },
          { value: "records", label: t("stats.tabs.records") },
        ]}
      />
      ...
      {tab === "overview" ? (
        <>
          ...
          {comparison ? (
            <section className="animate-in" style={{ animationDelay: `${staggerDelayMs(1)}ms` }}>
      ...
      {tab === "thisYear" ? (
        <section className="grid gap-4 lg:grid-cols-2 animate-in" style={{ animationDelay: `${staggerDelayMs(0)}ms` }}>
      ...
      {tab === "history" ? (
        <>
          <Panel className="animate-in" style={{ animationDelay: `${staggerDelayMs(0)}ms` }}>
      ...
      {tab === "records" ? (
        <section className="animate-in" style={{ animationDelay: `${staggerDelayMs(0)}ms` }}>
