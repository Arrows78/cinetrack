...
// usePeopleYouWatch) so TodayHub can call that hook once, fold its
// "is there anything to show" result into hasRecommendationContent, and
// pass the already-computed data straight in here — matching how
// becauseYouLiked/favouriteGenreRail are wired into the same
