...
const inputVariants = cva(
  "flex w-full border border-border text-foreground ring-offset-background file:border-0 file:bg-transparent file:text-body-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring aria-[invalid=true]:border-destructive aria-[invalid=true]:ring-destructive/30 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      size: {
        // Prominent inputs (search-bar.tsx).
        default: "h-11 rounded-2xl bg-card/70 px-4 py-2 text-body-sm",
        ...
        underline:
          "h-auto rounded-none border-0 bg-transparent px-0 py-0 text-heading-md ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0",
      },
    },
    defaultVariants: {
      size: "default",
