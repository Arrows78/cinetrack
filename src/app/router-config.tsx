...
const availabilityAlertsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/availability-alerts",
  component: lazyRouteComponent(() => import("@/pages/availability-alerts-page"), "AvailabilityAlertsPage"),
});
